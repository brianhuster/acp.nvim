# Contributing to acp.nvim

## Reporting issues

If you have a problem with acp.nvim, please [open an
issue](https://github.com/brianhuster/acp.nvim/issues/new) and do as
instructed

## Pull requests

If you would like to contribute to acp.nvim, please [open a pull
request](https://github.com/brianhuster/acp.nvim/pulls).
